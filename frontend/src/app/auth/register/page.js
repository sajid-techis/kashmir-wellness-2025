...
// This component provides a user registration form and interacts with the Redux authSlice
// to handle registration functionality, now styled with custom Kashmir Wellness colors
...
function RegisterPage() {
  ...
  // Effect to redirect after successful registration
  useEffect(() => {
    if (isAuthenticated) {
      ...
      <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md border border-gray-200
        ...
        {(error || localError) && (
          <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-md relative mb-6
            ...
            <span className="block sm:inline ml-2">{error || localError}</span>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            >
              ...
              {/* Admin role typically not available for self-registration */}
            </select>
          </div>
